...
class SubmisiController extends Controller
{
    ...
    public function all()
    {
        $sql = array(
            ...
            DB::raw('(select ((submisi_target - SUM(t_donatur.donatur_nominal))/1000) from t_donatur INNER JOIN t_submisi ON t_submisi.submisi_id = t_donatur.submisi_id GROUP BY t_donatur.submisi_id) as kekurangan_donasi'),
