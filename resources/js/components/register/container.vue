                    ...
                    <v-card>
                        ...
                        <v-stepper v-model="e1" vertical>
                                ...
                                <v-stepper-content step="1">
                                    <v-card-text>
                                        <v-form>
                                            <v-text-field label="Name Depan" name="firstname" prepend-inner-icon="person" type="text" :rules="firstnameRules" required filled clearable/>
                                            <v-text-field label="Nama Belakang" name="lastname" prepend-inner-icon="person" type="text" :rules="lastnameRules" required filled clearable/>
                                ...
                                <v-stepper-content step="2">
                                    <v-card-text>
                                        <v-form>
                                            <v-text-field id="password" label="Password" name="password" prepend-inner-icon="mdi-lock-open" type="password" :rules="passwordRules" required filled clearable/>
                                            <v-text-field id="passwordconfirm" label="Ketik Ulang Password" name="passwordconfirm" prepend-inner-icon="lock" type="password" :rules="passwordRules" required filled clearable/>
                                            <v-btn color="error" @click="reroutes('/')" class="mr-2">Daftar</v-btn>
